<?php
// DEBUG VERSION - Shows all navigation elements regardless of login state
...
<html>
<head>
    <title><?= SITE_NAME ?> - Gaming News & Casino Reviews (DEBUG)</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Arial', sans-serif; line-height: 1.6; color: #333; }
        .debug-bar { background: #fef3c7; border-bottom: 2px solid #f59e0b; padding: 10px 20px; font-size: 14px; }
        .debug-bar strong { color: #dc2626; }
...
<body>
    ...
    <div class="debug-bar">
        ...
        User Logged In: <strong><?= $user_logged_in ? 'YES' : 'NO' ?></strong> | 
        Session User ID: <strong><?= isset($_SESSION['user_id']) ? $_SESSION['user_id'] : 'NOT SET' ?></strong> |
        All auth buttons are forcefully displayed below for testing
    </div>
    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <!-- FORCE SHOW ALL BUTTONS FOR DEBUG -->
            <div class="auth-buttons">
                <a href="user-login.php" style="color: #4b5563; font-weight: 600; border: 2px solid #3b82f6; padding: 8px 16px; border-radius: 8px;">👤 Login</a>
